...
const double TICKS_PER_REVOLUTION = 4096; // For reference purposes.
...
void publish_quat() {
  ...
  quatOdom.pose.pose.position.x = odomNew.pose.pose.position.x*10;
  quatOdom.pose.pose.position.y = odomNew.pose.pose.position.y*10;
  quatOdom.pose.pose.position.z = odomNew.pose.pose.position.z;
  quatOdom.pose.pose.orientation.x = q.x();
  quatOdom.pose.pose.orientation.y = q.y();
  quatOdom.pose.pose.orientation.z = q.z();
  quatOdom.pose.pose.orientation.w = q.w();
  quatOdom.twist.twist.linear.x = odomNew.twist.twist.linear.x*10;
  quatOdom.twist.twist.linear.y = odomNew.twist.twist.linear.y*10;
  quatOdom.twist.twist.linear.z = odomNew.twist.twist.linear.z;
  quatOdom.twist.twist.angular.x = odomNew.twist.twist.angular.x*50;
  quatOdom.twist.twist.angular.y = odomNew.twist.twist.angular.y*50;
